...
if horario >= 5 or horario <= 6:
  ...
  if clima == 'frio' or clima == 'nublado' or clima == 'chuvoso':
    print("Pedir uma pizza e um refri seria uma boa pedida")
  if clima == 'fresco' or clima == 'quente' or clima == 'ameno':
     print("Jantar fora ou que tal uma balada?")  
else:
  if clima == 'frio' or clima == 'nublado' or clima == 'chuvoso':
    print("Que tal fazermos uma maratona de algum filme, série ou jogarmos um jogo?")
  else:
    print("Dormir cedo parece ser uma boa...")
